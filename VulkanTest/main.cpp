...
// std::optional은 C++17 전용, 추후 문제시 이 코드를 변경
// Physical Device에서 사용
...
private:
	...
	void createInstance() {
		...
		//// Create Instance with AppInfo, CreateInfo
	...
	void createLogicalDevice() {
		...
		// With DeviceQueueCreateInfo, DeviceCreateInfo
	...
	void createSwapChain() {
		...
		// Create Swapchain with SwapchainCreateInfo
	...
	VkSurfaceFormatKHR chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
		for (const auto& availableFormat : availableFormats) {
			// VK_FORMAT_B8G8R8A8_SRGB는 텍스쳐 색상을 정상적으로 출력하지만, 일반 색상을 다르게 출력한다.
			// VK_FORMAT_B8G8R8A8_UNORM은 텍스쳐 색상을 어둡게 출력한다.
